...
import { reactive } from 'vue';
  ...
  const estado = reactive({
    ...
    const getTarefasPendentes =() => {
      ...
      const pendenteList = tarefas.filter(tarefa => !tarefa.finalizada)
...
<template>
  <div class="container">
    ...
    <form @submit.prevent="cadastraTarefa">
      <div class="row">
        <div class="col">
      <input :value="estado.tarefaTemp" @change="evento => estado.tarefaTemp = evento.target.value" required type="text" placeholder="Digíte aqui a descrição da tareda" class="form-control">
    </div>
    <div class="col-md-2">
